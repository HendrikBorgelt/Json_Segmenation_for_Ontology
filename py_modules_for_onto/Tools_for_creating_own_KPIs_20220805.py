...
def create_add_and_save_kpis_in_ontology_and_images(dict_int, emmo_int=emmo_int_1):
    with emmo_int:
                ...
                for i_int_4 in ['Rate', 'RMS Res', 'Max Res', 'Convergence_Rate']:
                    try:
                        with emmo_int:
                            ...
                            test = list_of_emmo_individuals(emmo_int)
                            if sim_name not in test :
                                test_1 = sim_name
