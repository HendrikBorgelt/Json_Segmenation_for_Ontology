...
class ModifyOnto:
    ...
    def __init__(self,
                 ...
                 onto_subject: str or owlready2.prop.ObjectPropertyClass or owlready2.prop.DataPropertyClass or None
                 = None,
                 onto_predicate: str or None = None,
                 onto_object: str or None = None,
                 onto_superclass_class: str or None = None,
                 onto_class: owlready2.owl_class or None = None,
                 onto_current_individual: str or None = None,
                 onto_super_object_property: owlready2.prop.ObjectPropertyClass or None = None,
                 onto_object_property: str or None = None,
                 onto_super_data_property: owlready2.prop.DataPropertyClass or None = None,
                 onto_data_property: str or None = None,
                 subject_str_int: str or None = None,
                 obj_str_int: str or None = None,
    ...
    def create_new_class(self):
        ...
        intermediate_list = [new_class.prefLabel[0], new_class]
    ...
    def create_individual_connection(self):
    ...
    def place_data_with_inventory(self,
                                  subject_str: str,
                                  predicate_str: str,
                                  data_str_or_float: str or float or int) -> None:
        """
        :param subject_str:
        :param predicate_str:
